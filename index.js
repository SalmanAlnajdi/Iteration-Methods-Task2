...
******************************************************************/
let incomes = transactions.filter(transaction => transaction[0] == "income");
console.log(incomes)

let expenses = transactions.filter(transaction => transaction[0] == "expense");
...
//How reduce work  >>>>>  numberInNestedArray.reduce((acc, cur) => acc + (cur[0] - cur[1]), 0)
                                                        ///         ^                 ^
                                                        ///        total   value of this index


let totalIncomes = incomes.reduce((total,value)=> total +( value[1] ),0);

console.log(totalIncomes)

let tatolExpenses = expenses.reduce((total,value)=> total +(value[1]),0)

console.log(tatolExpenses)
...
let netTotal = totalIncomes - tatolExpenses 
console.log(netTotal)

let t6 = transactions.filter(transaction => transaction[1] > 500 )
console.log(t6)
